      ...
      <div style={{ width: '100%', maxWidth: 560 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ margin: '8px 0 0', fontSize: 15, color: '#667085' }}>
            Buchungssystem für dein Hotel in wenigen Minuten einrichten.
          </p>
        </div>
        ...
        <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 20, padding: 32 }}>
          <form action={action} style={{ display: 'grid', gap: 18 }}>
            ...
            <div>
              ...
              <input id="reg-invite" name="inviteCode" type="text" placeholder="Einladungscode eingeben" style={inputStyle} />
            </div>
