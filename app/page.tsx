  ...
  return (
    <div style={{ fontFamily: 'Inter, ui-sans-serif, system-ui, -apple-system, sans-serif', color: '#111' }}>
      ...
      <style>{`
        ...
        .lp-logo { height: 48px; }
        .lp-nav-btn { padding: 10px 22px; font-size: 15px; text-align: center; }
        ...
        @media (max-width: 480px) {
          .lp-hero-badges { flex-direction: column; align-items: center; }
        }

        .lp-compare-table { width: 100%; border-collapse: collapse; }
        .lp-compare-table th, .lp-compare-table td { padding: 14px 16px; text-align: center; font-size: 14px; border-bottom: 1px solid #f0f0f0; }
        .lp-compare-table th:first-child, .lp-compare-table td:first-child { text-align: left; font-weight: 500; color: #444; }
        .lp-compare-table thead th { font-size: 13px; font-weight: 700; color: #666; padding-bottom: 16px; }
        .lp-compare-table thead th.bw-col { color: #111; font-size: 15px; background: #f9fafb; border-radius: 12px 12px 0 0; }
        .lp-compare-table tbody td.bw-col { background: #f9fafb; font-weight: 600; }
        .lp-compare-table tbody tr:last-child td { border-bottom: none; }
        .lp-compare-table tbody tr:last-child td.bw-col { border-radius: 0 0 12px 12px; }
        .lp-check { color: #16a34a; font-size: 18px; }
        .lp-cross { color: #d1d5db; font-size: 18px; }
        .lp-partial { color: #f59e0b; font-size: 13px; font-weight: 500; }
        @media (max-width: 640px) {
          .lp-compare-table th, .lp-compare-table td { padding: 10px 8px; font-size: 12px; }
          .lp-compare-col-hide { display: none; }
        }
      `}</style>
      ...
      <section id="pricing" style={{ background: '#fff', padding: '80px 24px' }}>
        <div style={{ maxWidth: 950, margin: '0 auto' }}>
          ...
          <p style={{ textAlign: 'center', fontSize: 16, color: '#666', margin: '0 0 40px' }}>Keine Provision. Keine versteckten Kosten.</p>
