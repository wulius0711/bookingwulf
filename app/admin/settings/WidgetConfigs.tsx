              ...
              <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 14, overflow: 'hidden' }}>
                  ...
                  <div key={key}>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, padding: '13px 16px', cursor: 'pointer' }}>
                      ...
                      <span style={{ position: 'relative', display: 'inline-block', width: 46, height: 26, flexShrink: 0 }}>
                        ...
                        <span style={{ position: 'absolute', inset: 0, background: (form as Record<string, unknown>)[key] ? '#1e293b' : '#d1d5db', borderRadius: 26, transition: 'background 0.2s' }} />
                ...
                {form.enableInstantBooking && (
                  <>
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, padding: '13px 16px 13px 32px', background: '#fafafa', cursor: 'pointer' }}>
                      ...
                      <span style={{ position: 'relative', display: 'inline-block', width: 46, height: 26, flexShrink: 0 }}>
                        ...
                        <span style={{ position: 'absolute', inset: 0, background: form.hideRequestOption ? '#1e293b' : '#d1d5db', borderRadius: 26, transition: 'background 0.2s' }} />
