                ...
                <div style={{ display: 'grid', gap: 12 }}>
                  <div style={{ display: 'grid', gap: 6 }}>
                    {[
                      ...
                      { label: 'Status', value: selectedItem.data.status },
                    ].map(({ label, value }) => (
