  ...
  return (
    <main className="admin-page" style={{ fontFamily: 'Inter, ui-sans-serif, system-ui, sans-serif' }}>
      <div style={{ maxWidth: 640, display: 'grid', gap: 24 }}>
        ...
        <div>
          <h1 style={{ margin: 0, fontSize: 28, letterSpacing: '-0.02em', color: 'var(--text-primary)' }}>Preiszeitraum bearbeiten</h1>
          <p style={{ margin: '4px 0 0', fontSize: 14, color: 'var(--text-muted)' }}>Saison, Zeitraum und Preis anpassen.</p>
        </div>

        <form action={updateSeason} style={{ display: 'grid', gap: 20 }}>
          <div style={card}>
            <div style={cardHead}>
              <h2 style={{ margin: 0, fontSize: 14, fontWeight: 600, color: 'var(--text-primary)' }}>Preiszeitraum</h2>
            </div>
            <div style={cardBody}>
