...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navGroupDefs = [
    { label: 'Betrieb', items: [
      ...
      { href: '/admin/housekeeping', label: 'Housekeeping', icon: 'housekeeping' },
    ...
    { label: 'Konfiguration', items: [
      ...
      { href: '/admin/chatbot', label: 'Gast-Chatbot', icon: 'chat' },
    ...
    { label: 'Konto', items: [
      ...
      ...(isSuperAdmin ? [
        ...
        { href: '/admin/chat-analytics', label: 'Hasky-Auswertung', icon: 'chat' },
