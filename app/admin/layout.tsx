...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <script dangerouslySetInnerHTML={{ __html: `(function(){var t=localStorage.getItem('admin-theme');if(t&&t!=='indigo'&&(t==='classic'||t==='teal'))document.documentElement.classList.add('theme-'+t);})();` }} />
    <div
