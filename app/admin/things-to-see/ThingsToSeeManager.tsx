...
export default function ThingsToSeeManager({ hotelId, initialItems, apartments }: { hotelId: number; initialItems: Item[]; apartments: Apartment[] }) {
  ...
  async function deleteItem(id: number) {
    ...
    await fetch(`/api/admin/things-to-see/${id}`, { method: 'DELETE' });
          ...
          {!showManualForm ? (
            ...
            <div style={{ display: 'grid', gap: 10 }}>
              ...
              <div className="two-col-grid" style={{ gap: 10 }}>
                ...
                <div>
                  <label style={{ fontSize: 12, fontWeight: 700, color: '#6b7280', display: 'block', marginBottom: 4 }}>Kategorie</label>
              ...
              <div>
                <label style={{ fontSize: 12, fontWeight: 700, color: '#6b7280', display: 'block', marginBottom: 4 }}>Beschreibung</label>
              ...
              <div className="two-col-grid" style={{ gap: 10 }}>
                ...
                <div>
                  <label style={{ fontSize: 12, fontWeight: 700, color: '#6b7280', display: 'block', marginBottom: 4 }}>Maps-Link</label>
