...
const COMPARISON: FeatureGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Direktnachrichten an Gäste', starter: false, pro: true, business: true },
      { label: 'Nachrichten für Airbnb/Booking.com-Gäste (ein Posteingang für alle Kanäle)', starter: false, pro: false, business: true },
