  ...
  '@graph': [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Wie migriere ich von anderen Anbietern oder Buchungsportalen?',        acceptedAnswer: { '@type': 'Answer', text: 'Der Wechsel ist unkompliziert: Apartments neu anlegen, bestehendes Widget durch das bookingwulf-Widget ersetzen, fertig. Bei Fragen begleiten wir Sie persönlich durch die Umstellung.' } },
