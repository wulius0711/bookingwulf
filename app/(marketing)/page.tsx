...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* ── Provisions-Rechner ───────────────────────────────────── */}
      <section className="v4-section v4-angled" style={{ background: 'var(--v4-navy)', paddingTop: 152, paddingBottom: 152 }} aria-labelledby="pain-heading">
      ...
      {/* ── Pricing ──────────────────────────────────────────────── */}
      <section id="pricing" className="v4-section v4-grain v4-angled" style={{ background: 'var(--v4-navy)', paddingTop: 152, paddingBottom: 152 }} aria-labelledby="pricing-heading">
        <div className="v4-container">
