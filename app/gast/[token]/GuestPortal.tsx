...
const TRANSLATIONS = {
  de: {
    ...
    accessCode: '🔑 Dein Zugangscode', accessCodeValid: 'Gültig von Anreise bis Abreise',
    ...
    noMessages: (h: string) => `Noch keine Nachrichten. Schreibe dem ${h}-Team direkt hier.`,
    msgPlaceholder: 'Nachricht schreiben …',
    msgError: 'Nachricht konnte nicht gesendet werden. Bitte versuche es erneut.',
    checkoutHead: 'Abreise', checkoutTime: 'Check-Out Zeit',
    checkoutDesc: 'Wenn du zur Abreise bereit bist, informiere das Team mit einem Klick — kein Warten an der Rezeption nötig.',
    checkoutBtn: 'Jetzt auschecken', goodbye: 'Auf Wiedersehen!',
    goodbyeText: 'Vielen Dank für deinen Aufenthalt. Das Team wurde über deine Abreise informiert.',
    reviewPrompt: 'Hat dir dein Aufenthalt gefallen? Wir freuen uns über eine Bewertung!',
...
export default function GuestPortal({ token, booking, hotel, apartments, allExtras, serverBookedExtraIds, thingsToSee, checkinImages, translations, initialMessages }: Props) {
  ...
  const css = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .welcome-card { position:relative; background:#fff; border-left:4px solid var(--accent); border-radius:0; border-bottom:1px solid #f0f0f0; padding:16px 44px 16px 20px; animation:welcomeSlide 0.25s ease; }
