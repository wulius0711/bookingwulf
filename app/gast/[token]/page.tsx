  ...
  return (
    <GuestPortal
      ...
      booking={{
        ...
        nukiCode: (isAfterCheckout || !request.checkinOnsiteConfirmedAt) ? null : request.nukiCode,
        hasNukiCode: !!request.nukiCode,
        onsiteConfirmed: !!request.checkinOnsiteConfirmedAt,
      ...
      hotel={{
        ...
        checkoutInfo: hotel?.settings?.checkoutInfo ?? null,
